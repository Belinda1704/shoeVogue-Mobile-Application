...
import 'package:shoe_vogue/app/translations/app_translations.dart';
import 'package:shoe_vogue/app/modules/home/controllers/home_controller.dart';
import 'package:shoe_vogue/app/modules/cart/controllers/cart_controller.dart';
import 'package:shoe_vogue/app/modules/favorites/controllers/favorites_controller.dart';
...
// Create mock classes
void main() {
  // Setup function to initialize common dependencies
  setUp(() {
    // Initialize GetX dependencies
    final mockFirestoreService = MockFirestoreService();
    final mockAuthService = MockAuthService();
    
    // Return empty lists/values for common method calls
    when(mockFirestoreService.getBanners()).thenAnswer((_) => Stream.value([]));
    
    // Put mocked services in Get's dependency injection
